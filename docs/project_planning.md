...
- **Subtask 1.1.1.7:** Configure Redux Toolkit store (slices for UI state)
- **Subtask 1.1.1.8:** Configure React Query (query client, providers)
- **Subtask 1.1.1.9:** Set up ShadcnUI components

#### Task 1.1.2: Backend Project Initialization
- **Subtask 1.1.2.1:** Initialize Nest.js project with TypeScript
- **Subtask 1.1.2.2:** Configure TypeScript and Nest.js CLI
- **Subtask 1.1.2.3:** Configure environment variables (.env)
- **Subtask 1.1.2.4:** Set up Nest.js folder structure (modules, controllers, services, guards, decorators)
- **Subtask 1.1.2.5:** Install core dependencies (@nestjs/core, @nestjs/common, @nestjs/platform-socket.io, @nestjs/jwt, Socket.io, Prisma, Zod)

#### Task 1.1.3: Database Setup
- **Subtask 1.1.3.1:** Set up PostgreSQL database (local, Neon, or Supabase)
- **Subtask 1.1.3.2:** Configure Prisma ORM for PostgreSQL
- **Subtask 1.1.3.3:** Create initial Prisma schema (Users, Bots, Games, TableSessions, GamePlayers models)
- **Subtask 1.1.3.4:** Set up Prisma migrations for PostgreSQL
- **Subtask 1.1.3.5:** Create seed scripts for testing

#### Task 1.1.4: Development Tools Setup
- **Subtask 1.1.4.1:** Configure Git repository and .gitignore
- **Subtask 1.1.4.2:** Set up package.json scripts (dev, build, test)
- **Subtask 1.1.4.3:** Configure VS Code workspace settings
- **Subtask 1.1.4.4:** Set up hot-reload for development
...
- **Subtask 2.1.1.1:** Define card interface/type (rank, suit, value, points, id)
- **Subtask 2.1.1.2:** Create card ranking constants (2 > A > K > ... > 3)
- **Subtask 2.1.1.3:** Create suit ranking constants (Hearts > Diamonds > Clubs > Spades)
